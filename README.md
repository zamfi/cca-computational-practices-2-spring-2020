...
3. Copy the JSON object from [this document](runner.json) into [JSON Editor Online](https://jsoneditoronline.org), and explore what data actually shows up in there. Explore enough that you have an educated guess about the "position" of the "nose".
